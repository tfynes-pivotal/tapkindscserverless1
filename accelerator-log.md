...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [hello-fun->tapkindscserverless1]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: hello-fun->: tapkindscserverles...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [dev.local->https://github.com/t...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [hello-fun template repo->tapkindscserverless1]
